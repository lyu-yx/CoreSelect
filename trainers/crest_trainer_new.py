...
class CRESTTrainer(SubsetTrainer):
    ...
    def _select_coreset(self, pool_indices, epoch: int):
        ...
        if selection_method == "mixed":
            # Internal mixed selection implementation (formerly _internal_mixed_selection)
            ...
            try:
                ...
                for c_idx, cls in enumerate(classes):
                    ...
                    class_features = gradients[class_indices]
                ...
                subset_indices = np.array(all_indices, dtype=np.int32)
        ...
        # TODO: Implement other selection methods if needed
            ...
            weights = np.ones(len(subset_indices)) / len(subset_indices)
